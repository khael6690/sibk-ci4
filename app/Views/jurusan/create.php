<div class="modal fade" id="modal-create-jurusan">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="<?= base_url('jurusan') ?>" method="POST" class="form-horizontal form-create-jurusan">
                        <?= csrf_field() ?>
                        <div class="form-group row">
                            <label for="nama_jurusan" class="col-sm-4 col-form-label">Nama Jurusan</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" value="<?= old('nama_jurusan') ?>" placeholder="Ilmu Pengetahuan ....">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="singkatan" name="singkatan" value="<?= old('singkatan') ?>" placeholder="IP...">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-create-jurusan').submit(function(e) {
            e.preventDefault();
            var form = $(this);
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#modal-create-jurusan').modal('hide');
