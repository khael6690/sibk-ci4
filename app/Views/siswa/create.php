    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="<?= base_url('siswa') ?>" method="POST" class="form-horizontal form-create">
                        <?= csrf_field() ?>
                        <div class="form-group row">
                            <label for="nis" class="col-sm-4 col-form-label">NIS</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nis" name="nis" value="<?= old('nis') ?>" placeholder="000 000 000 000">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="kelas_id" name="kelas_id">
                                    <?php foreach ($data_kelas as $value) { ?>
                                        <option value="<?= $value['kelas_id']; ?>" <?= $value['kelas_id'] === old('kelas_id') ? 'selected' : ''; ?>><?= $value['nama_kelas'] . " - " . $value['singkatan']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?= old('no_hp') ?>" placeholder="800 0000 0000">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" rows="2" id="alamat" name="alamat" placeholder="Jl. ....." style="resize: none;"><?= old('alamat') ?></textarea>
