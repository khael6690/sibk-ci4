<div class="modal fade" id="modal-create-tata">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="<?= base_url('tata-tertib') ?>" method="POST" id="form-create-tata" class="form-horizontal">
                        <?= csrf_field() ?>
                        <div class="form-group row">
                            <label for="nama" class="col-sm-4 col-form-label">Tata tertib</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama" name="nama" value="<?= old('nama') ?>" placeholder="Nama tata tertib...">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2" id="kategori_id" name="kategori_id">
                                    <?php foreach ($data_kategori as $value) { ?>
                                        <option value="<?= $value['kategori_id']; ?>" <?= old('kategori_id') === $value['kategori_id'] ? 'selected' : ''; ?>><?= $value['nama']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" rows="3" id="deskripsi" name="deskripsi" placeholder="Deskripsi tata tertib..." style="resize: none;"><?= old('deskripsi') ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="hukuman" class="col-sm-4 col-form-label">Hukuman</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" rows="3" id="hukuman" name="hukuman" placeholder="Hukuman ..." style="resize: none;"><?= old('hukuman') ?></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-create-tata').submit(function(e) {
            e.preventDefault();
            var form = $(this);
            $.ajax({
